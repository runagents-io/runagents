!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](_generated/specs/deploy.yaml)
    - [Redoc for Deploy API](redoc/?spec=_generated/specs/deploy.yaml)
    - [Swagger UI for Deploy API](swagger/?spec=_generated/specs/deploy.yaml)

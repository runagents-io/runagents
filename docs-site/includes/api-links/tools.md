!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](../_generated/specs/tools.yaml)
    - [Redoc for Tools API](../redoc/?spec=../_generated/specs/tools.yaml)
    - [Swagger UI for Tools API](../swagger/?spec=../_generated/specs/tools.yaml)

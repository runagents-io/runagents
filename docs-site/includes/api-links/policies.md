!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](../_generated/specs/policies.yaml)
    - [Redoc for Policies API](../redoc/?spec=../_generated/specs/policies.yaml)
    - [Swagger UI for Policies API](../swagger/?spec=../_generated/specs/policies.yaml)

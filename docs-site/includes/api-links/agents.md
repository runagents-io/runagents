!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](_generated/specs/agents.yaml)
    - [Redoc for Agents API](redoc/?spec=_generated/specs/agents.yaml)
    - [Swagger UI for Agents API](swagger/?spec=_generated/specs/agents.yaml)

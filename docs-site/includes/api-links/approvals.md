!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](../_generated/specs/approvals.yaml)
    - [Redoc for Approvals API](../redoc/?spec=../_generated/specs/approvals.yaml)
    - [Swagger UI for Approvals API](../swagger/?spec=../_generated/specs/approvals.yaml)

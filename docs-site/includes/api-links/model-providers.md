!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](../_generated/specs/model-providers.yaml)
    - [Redoc for Model Providers API](../redoc/?spec=../_generated/specs/model-providers.yaml)
    - [Swagger UI for Model Providers API](../swagger/?spec=../_generated/specs/model-providers.yaml)

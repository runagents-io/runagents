...
<figure class="ra-shot">
  <img src="https://runagents-releases.s3.amazonaws.com/docs/screenshots/docs-refresh/agent-catalog.png" alt="RunAgents agent catalog view">
...
<figure class="ra-shot">
  <img src="https://runagents-releases.s3.amazonaws.com/docs/screenshots/docs-refresh/google-workspace-assistant.png" alt="Google Workspace assistant in RunAgents">

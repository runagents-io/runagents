...
def _check_contract_artifacts(errors: list[str]) -> None:
    ...
    if not openapi_file.exists():
        ...
        _expect_contains(errors, openapi_file, "/approvals/requests:")
        _expect_contains(errors, openapi_file, "/runs:")
        _expect_contains(errors, openapi_file, "/catalog:")
        _expect_contains(errors, openapi_file, "/deploy:")
        _expect_contains(errors, openapi_file, "/policies:")
        _expect_contains(errors, openapi_file, "/approval-connectors:")
        _expect_contains(errors, openapi_file, "/identity-providers:")
        _expect_contains(errors, openapi_file, "/agents:")
        _expect_contains(errors, openapi_file, "/tools:")
        _expect_contains(errors, openapi_file, "/model-providers:")
        _expect_contains(errors, openapi_file, "/chat/completions:")
        _expect_contains(errors, openapi_file, "/builds:")
        _expect_contains(errors, openapi_file, "/billing:")

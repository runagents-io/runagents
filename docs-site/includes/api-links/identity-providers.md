!!! info "Generated Reference Views"
    - [Filtered OpenAPI YAML](_generated/specs/identity-providers.yaml)
    - [Redoc for Identity Providers API](redoc/?spec=_generated/specs/identity-providers.yaml)
    - [Swagger UI for Identity Providers API](swagger/?spec=_generated/specs/identity-providers.yaml)
